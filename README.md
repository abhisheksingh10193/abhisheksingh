Station Management System
  A simple Python-based station management system for handling train reservations. This program allows users to register, update, search, and delete reservation records through an interactive console interface.

Features
  Register Reservations: Book tickets for multiple passengers at once
